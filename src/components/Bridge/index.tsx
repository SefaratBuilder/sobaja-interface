    ...
    return (
        <BridgeWrapper gap="10px">
            <Row jus="space-between" al="center">
                ...
                <Row al="center">
                    <AntSwitch onClick={() => setIsOpen(!isOpen)} checked={isOpen} />
                </Row>
            </Row>
            {
                isOpen && (
                        ...
                        <Row jus="space-between" al="center" gap="10px">
                            <SelectButton>
                                <Row gap="5px" al="center">
                                    <img className="token" src={ETH} alt="network icon" />
                                    <span>Ethereum</span>
                                </Row>
                            ...
                            <SelectButton>
                                <Row gap="5px" al="center">
                                    <img className="token2" src={Era} alt="network icon" />
                                    <span>Mainnet</span>
                                </Row>
                                <img className="chevron" src={Chevron} alt="chevron" />
                            </SelectButton>
                                ...
                                return(
                                    <BridgeItem bg={item.bg}>
                                        ...
                                        <Link href={item.to} target="_blank">
                                                Bridge 
                                                <img className="arrow" src={ArrowLink} alt="arrow-link" />
                                        </Link>
                                    </BridgeItem>
                                )
                            })}
