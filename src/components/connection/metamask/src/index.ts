...
import { detectEthereumProvider } from './MetaMaskEthereumProvider'
...
export class MetaMask extends Connector {
  ...
  private async isomorphicInitialize(): Promise<void> {
    ...
    return (this.eagerConnection = detectEthereumProvider(this.options).then(async (m) => {
      console.log("m", m)
      const provider = m
      if (provider) {
  ...
  public async activate(desiredChainIdOrChainParameters?: number | AddEthereumChainParameter): Promise<void> {
    ...
    return this.isomorphicInitialize()
      .then(async () => {
        ...
        console.log("desiredChainIdOrChainParameters11", accounts, chainId, receivedChainId, desiredChainId)
